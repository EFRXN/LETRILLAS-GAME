 ...
 <!--------------------------BANNER------------------------------------>
  ...
  <div class="banner">
    ...
    <div class="banner-text">
      <h1> <span= class="black"> Consulta tus </span=>  <spam= class="green" > RESULTADOS© </spam=> </h1>
	<a style="color: lightgreen; font-weight: bold"; href="index.php">Estadisticas globales</a>    
</div>
  </div>
...
// Obtener nombre de usuario del inicio de sesión (suponiendo que se almacena en una variable $nombreUsuario)

$nombreUsuario = $_POST['usuario'];
// Consulta todos los documentos en la colección filtrando por nombre de usuario
$filter = ['nombre' => $nombreUsuario];
$query = new MongoDB\Driver\Query($filter, ['sort' => ['puntuacion' => -1]]);
